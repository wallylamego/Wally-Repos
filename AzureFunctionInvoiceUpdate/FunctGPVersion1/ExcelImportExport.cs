...
namespace EmailGPExceptions
{
    public class ExcelImportExport
    {
        ...
        public async Task<bool> SaveFileExcelToAzureStorageAsync(List<GPException> ReportListing, string storageConnectionString, 
            string fileName, TraceWriter log, string containerString)
        {
        ...
        public async Task<bool> SaveFileExcelToAzureStorageAsync(List<GPException> ReportListing, string storageConnectionString,
            string fileName, TraceWriter log, string containerString, string ExistingFileName = null)
        {
